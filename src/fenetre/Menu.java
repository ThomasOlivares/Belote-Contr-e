...
public class Menu extends JPanel{
	...
	public void paintComponent(Graphics g){
		...
		try {
			...
			Image gauche = ImageIO.read(new File("images/valet_trefle.jpeg"));
			g.drawImage(gauche, 50, 250, this);
			Image droite = ImageIO.read(new File("images/as_coeur.jpeg"));
			g.drawImage(droite, this.getWidth()-50-Carte.getLargeur(), 250, this);
		} 
		catch (IOException e) {
			e.printStackTrace();
		}
